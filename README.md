...
**Note:** This repository contains .ipynb file. To make this application deployable, .ipynb file needs to be converted into .py file. Below readme file details are given according to .py file
